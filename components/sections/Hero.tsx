...
export function Hero() {
  return (
    <section className="hero relative min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-purple-50">
      <div className="hero-content text-center max-w-4xl mx-auto px-4">
        ...
        <p className="hero-subheadline text-lg md:text-xl text-gray-700 mb-8 max-w-2xl mx-auto">
