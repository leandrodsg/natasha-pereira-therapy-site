...
const HEADER_STYLES = {
  ...
  link: 'text-xs font-semibold uppercase tracking-widest text-[#662B2D] hover:text-[#662B2D]/70 transition-colors focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-[#662B2D] rounded',
  button:
